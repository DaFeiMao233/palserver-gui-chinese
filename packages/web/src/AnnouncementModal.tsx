...
/**
 * 極簡、零相依的 markdown 渲染器,涵蓋公告會用到的語法:標題、粗體/斜體/行內程式碼、
 * 連結、無序/有序清單、分隔線與段落,以及圖片與 YouTube/影片嵌入。內容雖來自我們自己的
 * repo,仍一律建成 React 節點(不用 dangerouslySetInnerHTML),避免注入原始 HTML。
 */
